...
## on fait rouler le glm pour avoir les prévisions
## de celui-ci
source("glm.R")
...
runs <- tuning_run("Cann_shallow_tuning.R",
                   runs_dir = "shallow_Cann_nb_neuronne",
                   flags = list(
                     dropout1 = c(0),
...
View(ls_runs(runs_dir ="shallow_Cann_nb_neuronne" ))
